...
if "__main__" == __name__:
    ...
    parser.add_argument(
        "--base_data_dir", type=str, default="/home/yinjun/dataset/replica-dataset", help="directory of training data"
    )
    parser.add_argument(
        "--base_ckpt_dir",
        type=str,
        default="/home/yinjun/project/Marigold-main/",
    ...
    # train_loader = DataLoader(train_set, batch_size = cfg.dataloader.max_train_batch_size,drop_last=True, shuffle=True, num_workers=cfg.dataloader.num_workers) 
    ...
    val_loader = DataLoader(
        val_set,
        batch_size=cfg.dataloader.max_train_batch_size,  # 可以设置不同的batch_size
        drop_last=False,  # 验证时通常不需要丢弃最后一个batch
